...
function admin() { const s=state.settings; return `<form id="admin-form"><div class="admin-grid"><div class="panel"><div class="panel-head"><h2>여비 기준</h2></div><div class="panel-body"><div class="form-grid">
    ...
    ${input('routeApiUrl','네이버 지도 거리 프록시 URL',s.routeApiUrl || '','url','full')}
    <div class="field full notice">GitHub Pages에서는 네이버 지도 비밀키를 저장할 수 없습니다. 배포한 거리 프록시의 <code>/route</code> URL을 입력하면 출장 작성 화면에서 왕복 거리를 자동 입력합니다.</div>
